...
export default function LoginPage() {
  ...
  <div style={{ background: "rgba(245,158,11,0.08)", border: "1px solid rgba(245,158,11,0.2)", borderRadius: 12, padding: "12px 16px", marginBottom: 20, fontSize: 13, color: "#f59e0b", textAlign: "center" }}>
        ...
        <form onSubmit={onSubmit} className="rounded-2xl border border-white/10 bg-[#121212] p-6 sm:p-8">
          ...
          {error && error !== "__unconfirmed__" && error !== "__no_plan__" && (
            ...
            {resetSent ? (
              <div style={{ textAlign: "center", padding: "8px 0 4px" }}>
                ...
                <button onClick={closeModal}
                  style={{ marginTop: 20, height: 44, padding: "0 40px", borderRadius: 10, background: "linear-gradient(135deg, #10b981, #059669)", border: "none", color: "black", fontSize: 14, fontWeight: 600, cursor: "pointer", boxShadow: "0 4px 24px rgba(16,185,129,0.25)", transition: "all 0.25s ease" }}
