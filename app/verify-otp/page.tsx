  ...
  <p className="text-[11px] font-medium text-amber-400">Si vous ne le voyez pas, vérifiez vos spams.</p>
          ...
          {success ? (
            ...
            <button
              ...
              onMouseEnter={e => { if (!loading && code.join("").length === 6) { e.currentTarget.style.boxShadow = "0 8px 32px rgba(16,185,129,0.4)"; e.currentTarget.style.transform = "translateY(-1px)"; } }}
