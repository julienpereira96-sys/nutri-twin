  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center", maxWidth: 520, width: "100%" }}>
        ...
        {/* Grand titre hors encadré */}
        <p style={{ margin: "0 0 6px", fontSize: 13, fontWeight: 600, color: "#10b981", letterSpacing: "0.12em", textTransform: "uppercase" }}>
          Paiement confirmé
        </p>
        <h1 style={{ fontSize: 26, fontWeight: 800, color: "white", margin: "0 0 32px", lineHeight: 1.2 }}>
        ...
        <div style={{
          ...
          <p style={{ margin: "0 0 20px", fontSize: 15, color: "#94a3b8", lineHeight: 1.8 }}>
