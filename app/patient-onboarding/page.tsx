  ...
  useEffect(() => {
    supabase.auth.getUser().then(async ({ data }) => {
      ...
      const { data: patient } = await supabase
        .from("patients")
        .select("age, sexe, taille, poids, pathologies, allergies, traitements, objectif_clinique")
          ...
          <div style={{ background: "#111111", borderRadius: 20, padding: 28, border: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
              ...
              <div>
                ...
                <select value={confirmSexe} onChange={(e) => setConfirmSexe(e.target.value)}
                  style={{ ...inputStyle, color: confirmSexe ? "white" : "#64748b" }}>
              ...
              {ALIMENTS.map((aliment) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      borderRadius: 20, padding: "8px 14px", fontSize: 13, fontWeight: 500, cursor: "pointer", border: "none",
                      background: aime ? "rgba(16,185,129,0.2)" : deteste ? "rgba(239,68,68,0.2)" : "rgba(255,255,255,0.05)",
                      color: aime ? "#10b981" : deteste ? "#f87171" : "#94a3b8",
                      transition: "all 0.2s",
                    }}
                  >
