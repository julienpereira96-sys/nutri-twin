            ...
            {hasMessages && (
              <>
                ...
                <div style={{ position: "relative", width: 44, height: 30, flexShrink: 0 }}>
                  {/* Avatar Jumeau — sobre, sans animation */}
                  <div style={{ position: "absolute", left: 0, top: 0, width: 30, height: 30, borderRadius: "50%", background: "#0b0f0d", border: "1.5px solid rgba(16,185,129,0.7)", boxShadow: "0 0 8px rgba(16,185,129,0.25)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 2 }}>
                    <svg width="15" height="15" viewBox="0 0 585 586" fill="none" xmlns="http://www.w3.org/2000/svg">
