        ...
        >
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 28, transform: "translateY(-24px)" }}>
            ...
            <div style={{ position: "relative", width: 140, height: 140 }}>
              ...
              {/* Cercle intérieur style login — halo + bordure émeraude pulsante */}
      ...
      <div style={{ textAlign: "center", marginBottom: 20 }}>
        <div style={{ position: "relative", width: 80, height: 80, margin: "0 auto 12px" }}>
          ...
          <button onClick={() => patientAvatarRef.current?.click()} disabled={uploadingPhoto}
            style={{ position: "absolute", bottom: 0, right: patientPhoto ? 22 : 0, width: 26, height: 26, borderRadius: "50%", background: ACCENT, border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: "right 0.2s" }}>
          ...
          {patientPhoto && (
            <button
              ...
              style={{ position: "absolute", bottom: 0, right: 0, width: 26, height: 26, borderRadius: "50%", background: "rgba(244,63,94,0.9)", border: "2px solid #0a0f0c", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}
    ...
    <div style={{ background: "#0a0f0c", borderRadius: 24, padding: 28, width: "100%", maxWidth: 360, border: "1px solid rgba(244,63,94,0.2)", textAlign: "center" }}>
      ...
      <aside style={{ width: sidebarOpen ? (isMobile ? "80vw" : sidebarWidth) : 0, minWidth: sidebarOpen ? (isMobile ? "80vw" : sidebarWidth) : 0, background: "#060908", display: "flex", flexDirection: "column", position: isMobile ? "fixed" : "relative", top: 0, left: 0, height: "100dvh", zIndex: isMobile ? 30 : 1, transition: "width 0.25s ease, min-width 0.25s ease", overflow: "hidden", flexShrink: 0, boxShadow: "4px 0 32px rgba(0,0,0,0.6)", borderRight: "1px solid rgba(16,185,129,0.08)", }}>
        <div style={{ width: isMobile ? "80vw" : sidebarWidth, display: "flex", flexDirection: "column", height: "100%", padding: "0 12px" }}>
          ...
          <div style={{ height: 84, padding: "0 16px", display: "flex", alignItems: "center", justifyContent: "space-between", background: "transparent", borderBottom: "1px solid rgba(255,255,255,0.05)", margin: "0 -12px", marginBottom: 16, flexShrink: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ width: 32, height: 32, borderRadius: "50%", border: "1px solid rgba(16,185,129,0.5)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <img src="/logo-new.svg" alt="" style={{ width: 17, height: 17 }} />
              </div>
          ...
          <div style={{ padding: isMobile ? "0 4px 44px" : "0 4px 52px", display: "flex", alignItems: "center", gap: 12, flexShrink: 0 }}>
            ...
            {hasMessages && (
              <>
                ...
                <div style={{ position: "relative", width: 52, height: 34, flexShrink: 0 }}>
                  ...
                  <div style={{ position: "absolute", left: 0, top: 0, width: 34, height: 34, borderRadius: "50%", background: "#0b0f0d", border: "1px solid rgba(16,185,129,0.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 2 }}>
                  ...
                  <div style={{ position: "absolute", right: 0, top: 4, width: 26, height: 26, borderRadius: "50%", border: "1px solid rgba(16,185,129,0.5)", zIndex: 1, overflow: "hidden" }}>
                    {patientPhoto ? (
