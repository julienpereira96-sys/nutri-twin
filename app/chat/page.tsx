      ...
      {showExercisesSheet && (
        ...
        >
          ...
          >
            ...
            {/* Titre + sous-titre */}
            <div style={{ textAlign: "center", padding: "18px 24px 20px", borderBottom: "1px solid rgba(255,255,255,0.06)", flexShrink: 0 }}>
              <p style={{ fontSize: 19, fontWeight: 700, color: TEXT_PRIMARY, letterSpacing: "-0.01em", margin: "0 0 8px" }}>Mes exercices</p>
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.52)", margin: 0, lineHeight: 1.5 }}>À utiliser quand vous en ressentez le besoin<br/>ou pour vous exercer.</p>
            </div>
            {/* Liste */}
      ...
      >
        ...
        {profileScreen === "voix" && (
          <>
            ...
            `}</style>
            <SubHeader title="Voix du Compagnon" />
            <div style={{ flex: 1, overflowY: "auto", paddingBottom: 24, paddingTop: 8 }}>
                    ...
                    >
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                        {isPreviewing && isVoicePlaying && (
                          /* Spectre organique — 8 barres, hauteurs et durées variées */
                          <div style={{ display: "flex", alignItems: "flex-end", gap: 2.5, height: 22, flexShrink: 0 }}>
                            {([
                              [7,0.82,0.00],[12,0.70,0.09],[20,0.88,0.04],
                              [22,0.75,0.14],[18,0.83,0.06],[13,0.71,0.11],
                              [9,0.79,0.17],[5,0.68,0.02],
                            ] as [number, number, number][]).map(([h, dur, delay], i) => (
                              <div key={i} style={{ width: 3, height: h, borderRadius: 2, background: ACCENT, transformOrigin: "bottom", animation: `vp-bar ${dur}s ease-in-out ${delay}s infinite` }} />
                            ))}
                          </div>
                        )}
                        {isSelected && (
              ...
              <div style={{ maxWidth: 580, width: "100%", textAlign: "center" }}>
                ...
                <div style={{ position: "relative", margin: "0 auto 28px", display: "inline-block" }}>
                  ...
                  <div style={{ position: "relative", width: 96, height: 96 }}>
                    <div style={{ width: 96, height: 96, borderRadius: "50%", background: "transparent", border: "2px solid rgba(16,185,129,0.6)", boxShadow: "0 0 20px rgba(16,185,129,0.35), 0 0 40px rgba(16,185,129,0.12)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
